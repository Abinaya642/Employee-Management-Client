...
export const EditEmployee = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4050/employee/getById/${selectId}`)
      .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`
        http://localhost:4050/employee/update/${selectId}`,
        formData,
        {
          headers: {
  ...
  return (
    <div className="">
      ...
      <form className="bg-white p-6 border rounded shadow-md" onSubmit={handleSubmit}>
        <div className="mb-4">
...
>
  ...
  <option value="Intern">Intern</option>
        ...
        <div className="flex justify-end">
          <button type="reset" className="bg-gray-300 text-black py-2 px-4 mr-3 rounded">
            Cancel
          </button>
